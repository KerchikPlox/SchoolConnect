...
CONFIG_TRAFARET = trafaret.Dict(
    {
        trafaret.Key("app"): trafaret.Dict(
            {"backend": trafaret.Dict({"host": trafaret.String(), "port": trafaret.Int(), }), }
        ),
        trafaret.Key("gino"): trafaret.Dict(
            {
        ...
        trafaret.Key("cors"): trafaret.Dict({"origins": trafaret.List(trafaret.String)}),
    }
)
